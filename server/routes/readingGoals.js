...
const createNewGoals = async (readerId, goalData, res) => {
    try {
        ...
        const newGoals = new ReadingGoal({
            reader_id: readerId,  // Keep this
            year_start: yearDates.start,
            year_end: yearDates.end,
            yearly_goal: goalData.yearly_goal || 0,
            yearly_progress: goalData.yearly_progress || 0,
            month_start: monthDates.start,
            month_end: monthDates.end,
            monthly_goal: goalData.monthly_goal || 0,
            monthly_progress: goalData.monthly_progress || 0,
            week_start: weekDates.start,
            week_end: weekDates.end,
            weekly_goal: goalData.weekly_goal || 0,
            weekly_progress: goalData.weekly_progress || 0
        });

        await newGoals.save(); // goal_id will be auto-generated by mongoose-sequence
